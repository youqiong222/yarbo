class FacetFiltersForm extends HTMLElement {
  ...
  static renderProductCount(html) {
    ...
    const productsCountNumberElement = new DOMParser()
      .parseFromString(html, 'text/html')
      .getElementById('ProductCount');
    const resultsCountNumber = productsCountNumberElement.querySelector(
      '.productsCountNumber',
    ).innerHTML;
    console.log('Products count number:', resultsCountNumber);
    const targetProductsCount = document.getElementById('productsCountNumber');
    if (targetProductsCount) {
      targetProductsCount.innerHTML = `(${resultsCountNumber})`;
    }
